...
<div id="toppanel">
	<div id="panel">
		<div class="content clearfix">
			...
			<div class="left">
				<!-- Login Form -->
				<form class="clearfix" action="categorias.php" method="post">
					<h1>Miembros</h1>
         ...
         <li><img src="img/naviseparator.gif" alt="" width="40" height="13" /></li>
          ...
          <li><img src="img/naviseparator.gif" alt="" width="40" height="13" /></li>
           ...
           <li><a href="carrito.php" class="main">Carrito</a></li>
            	...
            	<div class="FL"><img src="img/productos.jpg"/></div>
                <div class="FR"></div>
        </div>
        <p align="center" style="clear:both"> <br /><a href="cat_procesadores.php"><img src="img/cat_procesadores.jpg" width="276" height="309"></a>
      <a href="cat_motherboards.php"><img src="img/cat_motherboards.jpg" width="276" height="309"></a>
	  <a href="cat_rams.php"><img src="img/cat_rams.jpg" width="276" height="309"></a>
