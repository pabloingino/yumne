...
$valido=true;
 $consulta2="SELECT * FROM usuario where nickname='$nickname' AND contrasena='$contrasena'";
        ...
        $_SESSION['idusuario']= $rowsresult['idusuario'];
             ...
             header("location:cat_motherboards.php?login=true");
...
$query_listado = "SELECT * FROM productos WHERE id_cat=2";
...
<div id="toppanel">
	<div id="panel">
		<div class="content clearfix">
			...
			<div class="left">
				<!-- Login Form -->
				<form class="clearfix" action="cat_motherboards.php" method="post">
					<h1>Miembros</h1>
         ...
         <li><img src="img/naviseparator.gif" alt="" width="40" height="13" /></li>
          ...
          <li><img src="img/naviseparator.gif" alt="" width="40" height="13" /></li>
           ...
           <li><a href="carrito.php" class="main">Carrito</a></li>
            	...
            	<div class="FL"><img src="img/mothersboards.jpg"/></div>
                <div class="FR"></div>
        </div>
        <div id="productos"><br />
